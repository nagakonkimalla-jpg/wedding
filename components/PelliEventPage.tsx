    ...
    return (
        <div className="min-h-screen bg-[#FDFBF7] pelli-paper-texture">
            ...
            <a href="/" className="fixed top-3 left-3 sm:top-4 sm:left-4 z-40 block">
                <div className="relative w-[56px] h-[56px] sm:w-[68px] sm:h-[68px] md:w-[80px] md:h-[80px] rounded-full overflow-hidden shadow-lg bg-white border border-[#D4A017]/30 transition-transform hover:scale-105">
                    <Image
